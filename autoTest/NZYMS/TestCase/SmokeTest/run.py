...
if __name__ == '__main__':
    ...
    '''
    pytest.main(['../SmokeTest/10_outboxprocess/test_outplan.py',
                 '-sv','--alluredir', '../../report/result', "--clean-alluredir"])
    '''
    '''
    pytest.main([
                 '../SmokeTest/01_goinboxprocess/test_goin_box_process.py',
                 '../SmokeTest/02_changeStoreProcess/test_changeStoreProcess.py',
