...
class Empty_Box_Dredge_Plan(BasePage):
    ...
    def give_list(self):
        ...
        """
        boxid = []
        coldid = self.get_attribute_info('x',"(//div[@class='ag-header-container'])[5]//span[@ref='eText' and text()='箱号']//parent::div//parent::div//parent::div",'col-id')
