...
class Structure_Monitoring(BasePage):
    ...
    def mouse_job(self):
        ...
        框选操作
        """
        self.clickandhold("x", "//div[@class='nzctos-lateral__body__deck nzctos-lateral__body__right']//div["
                               "@data-hno='05']")
        self.move_mouse_to_element("x", "//div[@class='nzctos-lateral__body__deck nzctos-lateral__body__right']//div["
                                        "@data-hno='01']")
        self.move_release()
        time.sleep(1)
