...
class Job_Order_Monitoring(BasePage):
    ...
    def order_info_check(self,input):
        """
        作业信息查验
        """
    ...
    def discharging_confirm(self):
        ...
        textclick.input_noclear_placeholder_click('请选择','admin',5)
    ...
    def Job_DischargingOrder(self,input):
        """
        工作指令卸船操作流程
        """
        self.Retrieve(input)
    ...
    def Job_SendBoxOrder(self,input):
        """
        工作指令-堆场发箱
        """
        self.Retrieve(input)
