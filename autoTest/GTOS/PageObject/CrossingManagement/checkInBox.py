...
class CheckInBox(BasePage):
    ...
    def input_info(self, input):
        ...
        self.click("x", "//div[starts-with(@class,'el-select-dropdown el-popper') and not (contains(@style,'display: "
        ...
        if self.elementExist("x",
            ...
            self.click("x", f"//div[starts-with(@class,'el-select-dropdown el-popper') and not (contains(@style,"
                            f"'display: none'))]//span[contains(text(),{input['进口道口号']})]")
