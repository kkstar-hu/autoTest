...
class UnshipN(RequestMain):
    ...
    def test_confirm_report_cancel(self):
        s = self.sheet[5]
        payload = json.loads(s["payload"])
        payload["scdId"] = [self.env.scd_id]
        res = self.request_main(s["method"], s["path"], json=payload)
    ...
    def test_add_ship_plan(self):
        ...
        self.env.dc_route_id = data["data"]["dtsVesselRouteEntityList"][1]["dtsRouteMachinesEntityList"][0]["drmRouteId"]

    def test_delete_ship_plan(self):
        s = self.sheet[10]
    ...
    def test_add_shift_task(self, task_type):
        s = self.sheet[13]
    ...
    def test_delete_shift_task(self, task_type):
        s = self.sheet[14]
    ...
    def test_tally_arrange_remove(self):
        s = self.sheet[17]
        payload = json.loads(s["payload"])
    ...
    def test_machine_diver_match(self):
        s = self.sheet[21]
        payload = json.loads(s["payload"])
    ...
    def test_machine_arrange_remove(self):
        s = self.sheet[22]
        self.env.cma_id = \
    ...
    def test_machine_arrange_delete(self):
        s = self.sheet[23]
        # 机械安排id
        self.env.dmc_id = \
    ...
    def test_workgroup_arrange(self):
        s = self.sheet[24]
        payload = json.loads(s["payload"])
    ...
    def test_workgroup_arrange_delete(self):
        s = self.sheet[25]
        payload = json.loads(s["payload"])
    ...
    def test_tally_report_delete(self, task_type):
        s = self.sheet[28]
    ...
    def test_tally_report_audit(self, task_type):
        s = self.sheet[29]
        goa_id = self.env.dc_goa_id if task_type == 'dc' else self.env.pk_goa_id
        payload = json.loads(s["payload"])
    ...
    def test_tally_report_audit_cancel(self, task_type):
        s = self.sheet[30]
        goa_id = self.env.dc_goa_id if task_type == 'dc' else self.env.pk_goa_id
        payload = json.loads(s["payload"])
        res = self.request_main(s["method"], s["path"].format(goa_id=goa_id), params=payload)
    ...
    def test_task_audit(self, task_type):
        s = self.sheet[31]
        dst_id = self.env.dc_dst_id if task_type == 'dc' else self.env.pk_dst_id
        payload = json.loads(s["payload"])
    ...
    def test_task_audit_cancel(self, task_type):
        s = self.sheet[32]
        dst_id = self.env.dc_dst_id if task_type == 'dc' else self.env.pk_dst_id
        payload = json.loads(s["payload"])
    ...
    def test_worksheet_wk_generate(self, task_type):
        s = self.sheet[33]
        dst_id = self.env.dc_dst_id if task_type == 'dc' else self.env.pk_dst_id
        if task_type == 'dc':
            self.env.dc_pws_id = \
    ...
    def test_worksheet_machine_generate(self, task_type):
        s = self.sheet[34]
    ...
    def test_worksheet_wk_delete(self, task_type):
        s = self.sheet[35]
        pws_id = self.env.dc_pws_id if task_type == 'dc' else self.env.pk_pws_id
        self.env.dc_wsw_id = \
    ...
    def test_worksheet_control_audit(self, task_type):
        s = self.sheet[36]
        pws_id = self.env.dc_pws_id if task_type == 'dc' else self.env.pk_pws_id
        payload= json.loads(s["payload"])
    ...
    def test_worksheet_control_audit_cancel(self, task_type):
        s = self.sheet[37]
        pws_id = self.env.dc_pws_id if task_type == 'dc' else self.env.pk_pws_id
        payload= json.loads(s["payload"])
        payload["pwsId"] = pws_id
    ...
    def test_worksheet_hr_audit(self, task_type):
        s = self.sheet[38]
        pws_id = self.env.dc_pws_id if task_type == 'dc' else self.env.pk_pws_id
        payload= json.loads(s["payload"])
        payload["pwsId"] = pws_id
    ...
    def test_worksheet_hr_audit_cancel(self, task_type):
        s = self.sheet[39]
        pws_id = self.env.dc_pws_id if task_type == 'dc' else self.env.pk_pws_id
        payload= json.loads(s["payload"])
        payload["pwsId"] = pws_id
    ...
    def run(self):
        self.test_get_user()
        self.test_add_vessel()
        self.set_values()
        self.test_add_schedule()
        self.test_confirm_report()
        self.test_subarea()
        self.test_add_berth_plan()
        self.test_add_bill()
        self.test_add_ship_plan()
        self.test_add_shift_task('dc')
        #self.test_tally_attend()  # 1
        self.test_tally_arrange()
        #self.test_machine_attend()  # 1
        #self.test_driver_arrange()  # 1
        self.test_machine_arrange()
        self.test_machine_diver_match()
        self.test_workgroup_arrange()
        self.test_berth()
        self.test_dc_tally_report()
        self.test_tally_report_audit('dc')
        self.test_task_audit('dc')
        self.test_worksheet_wk_generate('dc')
        self.test_worksheet_machine_generate('dc')
        self.test_worksheet_control_audit('dc')
        self.test_worksheet_hr_audit('dc')

    def delete(self):
        '''
        self.test_worksheet_hr_audit_cancel('dc')
        self.test_worksheet_control_audit_cancel('dc')
        self.test_worksheet_wk_delete('dc')
        self.test_task_audit_cancel('dc')
        self.test_tally_report_audit_cancel('dc')
        self.test_tally_report_delete("dc")
        self.test_workgroup_arrange_delete()
        self.test_machine_arrange_remove()
        self.test_machine_arrange_delete()
        self.test_tally_arrange_remove()
        '''
        self.test_delete_shift_task("dc")
        self.test_delete_ship_plan()
        self.test_delete_bill()
        self.test_delete_schedule()
        self.test_delete_vessel()


if __name__ == '__main__':
    a = UnshipN("10.166.0.131:20000")
    a.delete()
